"""
Django settings for DataTune_app project.
...
SECRET_KEY = 'django-insecure-p*=_dqwudib0brw&4imqc5=jv@we@a8m^s_uyqdou5=*!gjseb'
...
ROOT_URLCONF = 'DataTune_app.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
                 os.path.join(BASE_DIR, 'ml-app/build'),
         ]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
